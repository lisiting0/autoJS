...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.getChildById = exports.findChildById = exports.findClickableParent = exports.getById = exports.findAllById = exports.findAllByDescContains = exports.findByDescContains = exports.findAllByTextContains = exports.findByTextContains = exports.findById = exports.defaultTimeout = exports.defaultinterval = void 0;
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    if (!(item == null && m >= new Date().getTime())) return [3 /*break*/, 5];
                    return [4 /*yield*/, (0, accessibility_1.select)(function (x) { var _a; return (_a = x.desc) === null || _a === void 0 ? void 0 : _a.includes(text); }).first()];
                case 2:
                    item = _a.sent();
                    if (!!item) return [3 /*break*/, 4];
                    return [4 /*yield*/, (0, lang_1.delay)(i)];
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    if (!(items.length === 0 && m >= new Date().getTime())) return [3 /*break*/, 5];
                    return [4 /*yield*/, (0, accessibility_1.select)(function (x) { var _a; return (_a = x.desc) === null || _a === void 0 ? void 0 : _a.includes(text); }).all()];
                case 2:
                    items = _a.sent();
                    if (!(items.length === 0)) return [3 /*break*/, 4];
                    return [4 /*yield*/, (0, lang_1.delay)(i)];
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.removeTrailingSlash = exports.downloadFile = exports.getCurrentVersion = exports.hotUpdate = exports.SignalRHandler = exports.startListen = exports.onVolumeDown = exports.AppDeviceStatusType = exports.MainActivity = exports.onMainActivityStarted = void 0;
...
<vertical>
    <card w="*" h="40" cardCornerRadius="2dp" cardElevation="1dp" gravity="center_vertical">
        <horizontal>
            <text text="${environment_1.environment.appName} v${environment_1.environment.version}" padding="18 8 8 8" gravity="center_vertical" />
        </horizontal>
    </card>
...
`;
    ...
    onContentViewSet(contentView) {
        ...
        this.autoService.on("click", function () {
            // 用户勾选无障碍服务的选项时，跳转到页面让用户去开启
            if (autoService.isChecked() && !accessibility_1.accessibility.enabled) {
                accessibility_1.accessibility.enableService({
                    toast: true,
                });
            }
        ...
        this.confirm.on("click", () => {
            ...
            const { packageName, appName, channel } = this.getPackageInfo(selected);
            (0, app_base_v9_1.hotUpdate)(packageName, appName, undefined, channel, "http://192.168.16.149:33452");
        });
        this.hotUpdate = contentView.findView("hotUpdate");
        this.hotUpdate.on("click", () => {
            (0, app_base_v9_1.hotUpdate)(environment_1.environment.packageName, environment_1.environment.appName, environment_1.environment.version, environment_1.environment.channel, "http://192.168.16.149:33452");
        });
    }
    getPackageInfo(item) {
        switch (item) {
...
exports.environment = {
    production: false,
    packageName: "com.yuxiang.autojs.hotupdate.v9",
    appName: "HotUpdate",
    channel: "v1",
    adb: false,
    version: "1.0.2",
...
function init() {
    ...
    (0, shell_1.checkAccess)("adb").then((r) => {
        environment_1.environment.adb = r;
    });
    return id;
}
async function main() {
    ...
    ui.setMainActivity(activity_1.MainActivity);
}
main();
