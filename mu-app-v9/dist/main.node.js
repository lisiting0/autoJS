...
exports.MUMainActivity = MUMainActivity;
...
exports.environment = {
    production: false,
    packageName: "com.yuxiang.autojs.mu.app.v9",
    appId: "com.rytong.ceair",
    appName: "MU",
    channel: "v1",
    adb: false,
    version: "1.0.0",
...
const environment_1 = __webpack_require__(5737);
const mu_app_1 = __webpack_require__(9553);
...
async function main() {
    ...
    const muApp = new mu_app_1.MUApp();
    const handler = new signalr_1.MUSignalRHandler(device_1.device.androidId, "MU", (input) => muApp.CheckIn(input));
    handler.onConnected(() => {
        console.log("服务器已连接");
        muApp.init(handler);
    });
    ...
    console.log("初始化完成...");
    ui.setMainActivity(activity_1.MUMainActivity);
    console.log("页面加载中...");
}
...
async function test() {
    ...
    console.log(`启动APP: ${app.launch(environment_1.environment.appId)}`);
    const muApp = new mu_app_1.MUApp();
    const result = await muApp.CheckIn({ passengerName: "洪泉彬", ticketNo: "781-2474342672" });
    console.log(JSON.stringify(result));
}
main();
...
class MUApp {
    ...
    async getAccount() {
        ...
        // 获取登录账号
        let pearlMember = await selector.getById("txt_ffpno", 1000, 20000);
        let pearlMemberText = pearlMember.text;
        let cardNo = pearlMemberText.split("会员号")[1].trim();
        if (cardNo === "") {
    ...
    async openMine() {
        ...
        (_a = selector.findClickableParent(mineNavigation)) === null || _a === void 0 ? void 0 : _a.click();
    }
    async backToHome() {
        console.log(`adb权限${environment_1.environment.adb}`);
        let home = await selector.findByTextContains("首页", 100, 2000);
        if (!home) {
            let retry = 5;
            while (retry > 0) {
    ...
    async waitForLoading(interval, timeout) {
        ...
        timeout !== null && timeout !== void 0 ? timeout : (timeout = 100000);
    ...
    async waitForTip(throwError, clickConfirm, clickCancel) {
        var _a, _b;
        ...
        if (panel) {
            ...
            if (clickConfirm) {
                if (clickCancel) {
                    (_a = (await selector.findById("btn_left", 100, 1000))) === null || _a === void 0 ? void 0 : _a.click();
                }
                (_b = (await selector.findById("btn_right", 100, 1000))) === null || _b === void 0 ? void 0 : _b.click();
            }
            if (throwError) {
    ...
    async stopApp() {
        await (0, lang_1.delay)(2000);
        console.log(`关闭APP,adb权限 ${environment_1.environment.adb}`);
        if (environment_1.environment.adb) {
            this.log(`关闭APP ${await (0, shell_1.exec)(`am force-stop ${environment_1.environment.appId}`, { adb: true, })} `);
            process.exit(-666);
        }
        else {
            await this.backToHome();
    ...
    async restartApp() {
        console.log(`启动APP,adb权限 ${environment_1.environment.adb}`);
        if (environment_1.environment.adb) {
            this.log(`关闭APP ${await (0, shell_1.exec)(`am force-stop ${environment_1.environment.appId}`, { adb: true, })} `);
            await (0, lang_1.delay)(5000);
            this.log(`启动APP ${app.launch(environment_1.environment.appId)} `);
            return true;
        }
        else {
    ...
    async CheckIn(input) {
        ...
        try {
            ...
            if (checkinText && checkinText.parent) {
                await (0, accessibility_1.click)(checkinText.parent.boundsInScreen.centerX, checkinText.parent.boundsInScreen.centerY);
            }
            await this.waitForLoading();
            // 当前在代办列表。选择选座值机Tab
            ...
            if (xzzj && xzzj.length > 0) {
                if (xzzj[0].parent) {
                    (0, accessibility_1.click)((_b = xzzj[0].parent) === null || _b === void 0 ? void 0 : _b.boundsInScreen.centerX, (_c = xzzj[0].parent) === null || _c === void 0 ? void 0 : _c.boundsInScreen.centerY);
                }
            ...
            await (0, lang_1.delay)(500);
            await (0, accessibility_1.click)(515, 1200);
            await (0, lang_1.delay)(500);
            // 立即查询
            ...
            if (state === null || state === void 0 ? void 0 : state.text.includes("办理成功")) {
                if ((state === null || state === void 0 ? void 0 : state.text) === "部分办理成功") {
            ...
            const msg = error === null || error === void 0 ? void 0 : error.message;
            (_d = this._handler) === null || _d === void 0 ? void 0 : _d.log(msg);
            this._failedCount++;
            if (msg === null || msg === void 0 ? void 0 : msg.includes("网络是否有效")) {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.MUSignalRHandler = void 0;
const app_base_v9_1 = __webpack_require__(5757);
const environment_1 = __webpack_require__(5737);
class MUSignalRHandler extends app_base_v9_1.SignalRHandler {
    /**
     *
     */
    constructor(id, airline, handler1) {
        super(id, airline, '');
    ...
    start(url) {
        super.start(url);
        this.hubConnection.on("Checkin", (input) => {
...
exports.MUSignalRHandler = MUSignalRHandler;
